...
public class PokerTableController {
	...
	private void handleP2SitLeave() {
		...
		if (bP2Sit == false) {
			...
			mainApp.AddPlayerToTable(p);
			b2P2Name.setText(txtP2Name.getText());
			b2P2Name.setVisible(true);
	...
	private void handleP3SitLeave() {
		...
		if (bP3Sit == false) {
			...
			mainApp.AddPlayerToTable(p);
			b3P3Name.setText(txtP3Name.getText());
			b3P3Name.setVisible(true);
	...
	private void handleP4SitLeave() {
		...
		if (bP4Sit == false) {
			...
			mainApp.AddPlayerToTable(p);
			b4P4Name.setText(txtP4Name.getText());
			b4P4Name.setVisible(true);
	...
	private ParallelTransition createTransition(final ImageView iv, final ImageView ivStart, final Image img) {
		 ...
		 * TranslateTransition(Duration.millis(500), ivStart);
		 * 
		 * 
		 * translateTransition.setFromX(0); translateTransition.setToX(ivX -
		 * ivStartX1); translateTransition.setFromY(0);
		...
		// RotateTransition(Duration.millis(150), ivStart);
